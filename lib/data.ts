...
const data = {
  products: [
    ...
    },
    {
      ...
      slug: toSlug("ziitop Men's Running Walking Shoes Fashion Sneakers Mesh Dress Shoes Business Oxfords Shoes Lightweight Casual Breathable Work Formal Shoes"),
      category: 'Shoes',
      brand: 'ziitop',
    ...
    },
    {
      ...
      slug: toSlug('DLWKIPV Mens Running Shoes Tennis Cross Training Sneakers Fashion Non Slip Outdoor Walking Jogging Shoes Mesh Light Flexible Comfortable Breathable Shoes'),
      category: 'Shoes',
      brand: 'DLWKIPV',
  ...
  settings: [
    {
      ...
      availableLanguages: i18n.languages?.map((locale) => ({
        code: locale,
        name: locale
      })),
