...
import ImageHover from './imageHomer';
import Rating from './rationg';
import { formatNumber } from '@/lib/utils';
import ProductPrice from './productPrice';
import { IProduct } from '@/models/productModels';

const ProductCard = ({ product, hideBorder = false, hideDetails = false, hideAddToCart = false }: { product: IProduct; hideDetails?: boolean; hideBorder?: boolean; hideAddToCart?: boolean }) => {
  const ProductImage = () => (
